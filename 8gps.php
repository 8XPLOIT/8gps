...
/*
	Author 	: 8XPLOIT
	Team 	: 8XPLOIT Infinite Exploit!
	Tools 	: 8GPS - Information Gathering
	Fanspage: https://www.facebook.com/8xploit
...
function updated($version, $file)
{
	...
	if ($cek2[0] == $version) {
		...
		echo "\n[+] Updated to version $version\n[+] $ git clone https://github.com/8XPLOIT/8gps";
	}
}
...
╚█████╔╝╚██████╔╝██║     ███████║ v.".$version."
 ╚════╝  ╚═════╝ ╚═╝     ╚══════╝
       ...
       => 8GPS - Information Gathering <=                                        

Author   : 8XPLOIT
Contact  : 8xploit@gmail.com
FansPage : https://www.facebook.com/8xploit
